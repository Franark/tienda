    ...
    <table>
        ...
        <tbody>
            ...
            foreach ($tiposDocumento as $documento) {
                ...
                echo "<td><a href='?page=editarTipoDocumento&idTipoDocumento={$documento['idTipoDocumento']}'>Editar</a> | <a href='controller/tipoDocumentoControlador.php?accion=eliminar&idTipoDocumento={$documento['idTipoDocumento']}' onclick='return confirm(\"¿Está seguro de eliminar este tipo de documento?\")'>Eliminar</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
